...
red = createParticleGroup(400, (255, 0, 0))
green = createParticleGroup(400, (0, 255, 0))
blue = createParticleGroup(400, (0, 0, 255))
...
while running:
    ...
    # Clear the previous state of particles
    particles.clear()
    particles.extend(red)
    particles.extend(green)
    particles.extend(blue)
